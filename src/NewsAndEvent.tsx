		...
		<section className="py-16 bg-white/10 relative" id="news-and-events">
			...
			<div className="container mx-auto px-4">
				<div className="flex flex-col sm:flex-row justify-between items-start lg:items-center mb-10 gap-5">
					...
					<motion.button className="relative focus:outline-none flex items-center space-x-2 bg-clarc-blue hover:bg-clarc-gold text-white font-semibold px-5 py-4 lg:px-6 rounded-full transition duration-300 group" whileTap={{ scale: [0.95, 1] }} whileHover={{ scale: [0.95, 1] }}>
						<span className="mr-4 text-sm lg:text-base text-clarc-gold group-hover:text-clarc-blue">View All News</span>
