		...
		<div className="font-inter min-h-screen">
			<header>
				<nav className="flex flex-col">
					<div data-first-header className=" py-8 text-indigo-50 bg-indigo-900">
					...
					<div data-second-header className="py-2 border border-b border-gray-300 ">
						<div className="container mx-auto flex justify-between items-center px-2 sm:px-4 md:px6">
							<div className="py-4 flex gap-1 justify-center items-center">
								...
								<h1 className="text-3xl text-indigo-900 font-bold">Clarendon College</h1>
							</div>
				...
				<main>
					...
					<div className=" bg-indigo-900">
						<div className="grid grid-cols-2 sm:grid-cols-4 py-8 gap-5 container mx-auto text-indigo-50 text-sm md:text-base">
							<button className="px-6 py-2 border border-indigo-100 rounded-full">Online Resources</button>
							<button className="px-6 py-2 border border-indigo-100 rounded-full">International</button>
							<button className="px-6 py-2 border border-indigo-100 rounded-full">Arts and Culture</button>
							<button className="px-6 py-2 border border-indigo-100 rounded-full">Alumni</button>
						</div>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-16 justify-center container mx-auto my-16">
						<div className="py-24">
							...
							<div className="flex gap-5 justify-center py-5">
								<button className="px-6 py-4 text-indigo-50 font-semibold bg-indigo-900 rounded-xl">Philosophy of Education</button>
								<button className="px-6 py-4 text-indigo-900 font-semibold outline-2 outline-indigo-900 rounded-xl">Awards and Recognition</button>
							</div>
						</div>
					...
					<div className="flex justify-center container mx-auto my-16">
						...
						<div className="py-24">
							...
							<div className="flex gap-5 justify-center py-5">
								<button className="px-6 py-4 text-indigo-900 font-semibold outline outline-indigo-900 rounded-full hover:outline-none hover:bg-indigo-900 hover:text-indigo-50">Start your CLARC journey here</button>
							</div>
						</div>
					</div>
					...
					<div className="flex flex-col gap-10">
						<div data-header className="flex justify-between items-center container mx-auto">
							<h1 className="font-semibold text-3xl font-serif py-5 text-center text-gray-700">College News and Events</h1>
							<button className="px-6 py-3 text-indigo-900 font-semibold bg-indigo-300 rounded-full mr-5">View All News</button>
						</div>
