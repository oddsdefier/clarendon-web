...
const CarouselHero = () => {
	...
	return (
		<div className="w-full mx-auto bg-clarc-blue min-h-screen" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
