			...
			<div className="container mx-auto px-4 py-8">
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
					{resourceButtons.map((button) => (
						<Button key={button.label} variant="outline" className="w-full bg-transparent text-clarc-gold border-clarc-gold text-base hover:bg-clarc-gold hover:text-clarc-blue transition-colors duration-300 py-4" asChild>
