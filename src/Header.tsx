				...
				<div className="hidden md:flex p-3 text-indigo-50 bg-clarc-blue">
					<div className="flex justify-between container mx-auto px-2 text-sm sm:text-base sm:px-4 md:px6 h-8">
						<div className="w-full flex justify-end items-center gap-1">
							...
							<h1 className="text-[0.95rem]">Bayanihan, Odiong, Roxas Oriental Mindoro</h1>
						</div>
					</div>
				</div>
				<div>
					<div className="relative container mx-auto flex justify-between items-center p-3">
						<div className="flex gap-1 justify-center items-center">
							...
							<h1 className="text-base md:text-2xl text-clarc-blue font-semibold">Clarendon College</h1>
						</div>
						<div className="absolute hidden lg:flex w-full gap-10 items-center justify-center">
