...
const EnrollmentProcedures: React.FC = () => {
  ...
  const mainContent = (
    <div className="py-5 pb-24 lg:pb-48">
      <div>
        ...
        <p className="mb-4 leading-relaxed text-gray-600">
          Candidates must submit a PSA copy of their birth certificate along
          with form 137, form 138 and a Good Moral certificate with the
          Registrar's office from where you will be directed to make the
          necessary payments for enrolment.
        </p>
      </div>
