...
const Timeline: React.FC = () => {
	...
	return (
		<main className="container mx-auto lg:flex gap-12 lg:py-5 pb-10 px-4 lg:px-0" id="timeline">
			<div className="flex-1 lg:border-r lg:border-dotted lg:border-gray-200">
				{/* <Separator className="bg-clarc-gold/50 w-1/4 h-1" /> */}
				<header className="text-center p-5 lg:p-8 lg:mx-10 rounded-sm mb-5 lg:mb-10  bg-clarc-blue/100">
