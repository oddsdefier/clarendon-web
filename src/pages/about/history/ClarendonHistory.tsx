...
export default function ClarendonHistory() {
	...
	return (
		<main className="container mx-auto flex gap-12 py-5" id="history-clarendon">
			<div className="flex-1 border-r border-dotted border-gray-200">
				<header className="text-center p-8 mx-10 rounded-sm mb-10 bg-clarc-gold/100">
					<h1 className="text-2xl sm:text-3xl md:text-3xl font-bold text-clarc-blue mb-2">The Golden History of Clarendon College</h1>
