        ...
        <div className={divStyle}>
          ...
          <div id="founder">
            ...
            <p className={contentStyle}>
              ...
              trained at the University of Santo Tomas and Adamson's University
              to be an Educator and later at the University of the Philippines
              to be a Botanist, Maam Lucille or "Mama Lucy" as she is
              endearingly referred to, would spend her life in gardens and
        ...
        <div className={divStyle}>
          ...
          <div id="birth-of-clarendon">
            ...
            <p className={contentStyle}>
              ...
              quality education for preschoolers that was made accessible to the
              locale of Roxas, Oriental Mindoro. Along with her two daughters,
              Lucille Tesorero Bacay and Flerie Tesorero Sucgang, the Montessori
              flourished with its meagre staff and passionate parents. The
              parents of the first batch of students strongly encouraged this
              small Montessori to expand into Primary Education. With this
              impetus, the President of the Montessori Engr Juanito A. Bacay
              purchased a lot in Odiong to establish a private elementary school
              in 1998.
            </p>
          </div>
        </div>
        ...
        <div className={divStyle}>
          ...
          <div id="growth-and-evolution">
            ...
            <p className="text-base text-muted-foreground lg:text-lg">
              ...
              instruction from k-10 and degrees in BEED and BSED with majors in
              English and Mathematics. The following year Clarendon College
              would offer a BSBA program major in Business Management. In 2006,
              the college department would graduate its first batch of students
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground lg:text-lg">
              ...
              majors in Operations Management and Financial Management. Also,
              degrees in Information Systems and Tourism Management would be on
              offer by this year. In 2017, Clarendon would join the country in
              its plan to integrate with the ASEAN region by offering Senior
              High School capacitating the school as a k-12 center of education.
            </p>
          </div>
        </div>
          ...
          <div id="recent-achievements">
            ...
            <ul className="space-y-4">
              <li className="flex flex-col items-start space-y-2 sm:flex-row sm:space-x-3 sm:space-y-0">
                ...
                <p className={contentStyle}>
                  Became the region's only provider of the Bachelor's of Culture
                  and Arts Education (BCAED)
                </p>
              </li>
              <li className="flex flex-col items-start space-y-2 sm:flex-row sm:space-x-3 sm:space-y-0">
                <Badge
                ...
                <p className={contentStyle}>
                  ...
                  the first of its kind opened by a Private School in the region
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className={divStyle}>
          ...
          <div id="our-ongoing-mission">
            ...
            <p className={contentStyle}>
              ...
              betterment of our fellow men. Clarendon College continues to be a
              bastion of pride, carrying forward the legacy of its founder, Mama
              Lucy T. Tesorero, in cultivating minds and shaping futures.
            </p>
          </div>
        </div>
      </section>
