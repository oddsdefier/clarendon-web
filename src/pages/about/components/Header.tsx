...
const Header: React.FC<HeaderProp> = ({ img, title }) => {
  return (
    <div
      className="relative mb-10 mt-5 flex h-48 items-center overflow-hidden bg-primary opacity-90 md:rounded-sm"
      style={{
    ...
    >
      ...
      <div className="container z-10 mx-auto flex justify-center px-12 text-center">
        <h1 className="font-astralaga text-2xl font-semibold italic text-white/90 lg:text-4xl">
          {title}
        </h1>
      </div>
    </div>
